<PhoneFrame>
  <div className="mt-2 ios-card-soft p-5">
    ...
    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
      Evaluación, seguimiento y resumen. Un mockup funcional para probar el flujo
      en tiempo real.
    </p>
  </div>
  ...
  <div className="mt-5 ios-card p-5">
    ...
    <div className="mt-4 grid gap-3">
      <a href="/demo" className="ios-btn-primary w-full text-center">
        Entrar como Paciente
      </a>
      <a href="/pro" className="ios-btn-secondary w-full text-center">
